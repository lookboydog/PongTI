...
export default function ResultView({
  ...
  const mbtiDetails = [
    {
      label: "能量流向 / ENERGY FLOW",
      left: "外倾 / Extraversion (E)",
      right: "内倾 / Introversion (I)",
      leftPct: ePct,
      rightPct: iPct,
    },
    {
      label: "感知模式 / PERCEPTION MODE",
      left: "实感 / Sensing (S)",
      right: "直觉 / Intuition (N)",
      leftPct: sPct,
      rightPct: nPct,
    },
    {
      label: "决策模式 / DECISION MODE",
      left: "思考 / Thinking (T)",
      right: "情感 / Feeling (F)",
      leftPct: tPct,
      rightPct: fPct,
    ...
    <div id="result-view-container" className="py-10 space-y-12">
      ...
      >
        ...
        <div className="space-y-4">
          <h1
            className={`text-3xl md:text-5xl font-extrabold pb-2 ${
              isDark
          ...
          <p
            className={`text-base font-mono font-extrabold tracking-widest uppercase ${
      ...
      {matchedChar && (
        <section id="mlp-match-section" className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <h2
              className={`text-2xl md:text-3xl font-black flex items-center justify-center space-x-2 ${
          ...
          <div
            className={`p-6 md:p-10 rounded-3xl border overflow-hidden relative group transition-all duration-500 ${
              isDark
          ...
          >
            ...
            <div
              className={`absolute top-0 left-0 right-0 h-2 bg-gradient-to-r ${
                getMbtiGroup(matchedChar.mbti) === "Analysts"
                  ? "from-indigo-500 via-purple-500 to-indigo-600"
                  : getMbtiGroup(matchedChar.mbti) === "Diplomats"
                    ? "from-pink-500 via-rose-500 to-pink-600"
                    : getMbtiGroup(matchedChar.mbti) === "Sentinels"
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-start relative z-10 pt-2">
              ...
              <div className="md:col-span-5 flex flex-col items-center text-center space-y-6">
                ...
                <div className="w-full flex justify-between items-center px-1 font-mono text-[10px] tracking-widest text-stone-500 border-b border-stone-800/20 dark:border-stone-500/10 pb-2">
                  ...
                  <span className="font-bold text-cyan-500/80">
                    NO. {matchedChar.id.toUpperCase()}
                  </span>
                </div>
                ...
                <div className="w-[90%] mx-auto aspect-square relative rounded-3xl overflow-hidden mt-1">
                  {isImageUrl(matchedChar.avatar) ? (
                    ...
                    <div
                      className={`w-full h-full rounded-3xl flex items-center justify-center text-7xl md:text-8xl ${
                        isDark
                ...
                <div className="space-y-4 w-full px-2">
                  <div className="flex flex-col items-center space-y-2">
                    <h3
                      className={`text-4xl font-extrabold tracking-tight ${isDark ? "text-white" : "text-stone-850"}`}
                    >
                      {matchedChar.name}
                    </h3>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2 pt-1">
                      <span
                        className={`text-[12px] font-mono tracking-widest font-black px-3 py-1 rounded-full border shadow-sm ${
                          getMbtiGroup(matchedChar.mbti) === "Analysts"
                ...
                <div className="w-[90%] mx-auto space-y-2.5 pt-4 border-t border-stone-800/10 dark:border-stone-500/10">
                  <div className="flex justify-between text-xs font-black">
                    ...
                    >
                      类型匹配度 / TYPE RESONANCE
                    </span>
                    <span
                      className={`font-mono text-lg font-black tracking-tight ${isDark ? "text-cyan-400" : "text-[#b3a076]"}`}
                    >
                      {simScore}%
                    </span>
                  </div>
                  <div
                    className={`h-3 w-full rounded-full overflow-hidden p-[2px] ${isDark ? "bg-stone-950 border border-stone-800" : "bg-stone-250/50"}`}
                  >
                    <div
                ...
                <div
                  className={`w-[90%] mx-auto space-y-2.5 pt-3.5 font-mono text-[11px] p-4 rounded-2xl border ${
                    isDark
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between">
                      <span
                        className={
                          matchedChar.stats.E >= matchedChar.stats.I
                            ? isDark
                      ...
                      >
                        E 外倾 {matchedChar.stats.E}%
                      </span>
                      <span
                        className={
                          matchedChar.stats.I >= matchedChar.stats.E
                            ? isDark
                              ? "font-black text-cyan-400"
                              : "font-black text-cyan-700"
                            : isDark
                      ...
                      >
                        {matchedChar.stats.I}% 内倾 I
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span
                        className={
                          matchedChar.stats.S >= matchedChar.stats.N
                            ? isDark
                              ? "font-black text-cyan-400"
                              : "font-black text-cyan-700"
                            : isDark
                      ...
                      >
                        S 实感 {matchedChar.stats.S}%
                      </span>
                      <span
                        className={
                          matchedChar.stats.N >= matchedChar.stats.S
                            ? isDark
                              ? "font-black text-cyan-400"
                              : "font-black text-cyan-700"
                            : isDark
                      ...
                      >
                        {matchedChar.stats.N}% 直觉 N
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span
                        className={
                          matchedChar.stats.T >= matchedChar.stats.F
                            ? isDark
                              ? "font-black text-cyan-400"
                              : "font-black text-cyan-700"
                            : isDark
                      ...
                      >
                        T 理智 {matchedChar.stats.T}%
                      </span>
                      <span
                        className={
                          matchedChar.stats.F >= matchedChar.stats.T
                            ? isDark
                      ...
                      >
                        {matchedChar.stats.F}% 情感 F
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span
                        className={
                          matchedChar.stats.J >= matchedChar.stats.P
                            ? isDark
                              ? "font-black text-cyan-400"
                              : "font-black text-cyan-700"
                            : isDark
                      ...
                      >
                        J 规则 {matchedChar.stats.J}%
                      </span>
                      <span
                        className={
                          matchedChar.stats.P >= matchedChar.stats.J
                            ? isDark
                              ? "font-black text-yellow-400 animate-pulse"
              ...
              <div className="md:col-span-7 space-y-7">
                ...
                <div className="space-y-3">
                  <h4 className="text-[11px] font-black tracking-widest text-stone-500 dark:text-stone-400 uppercase flex items-center space-x-2 border-b border-stone-800/10 dark:border-stone-500/10 pb-2">
                    ...
                    <span>认知功能画像 / COGNITIVE PROFILE</span>
                  </h4>
                  <div
                    className={`p-5 rounded-2xl border text-sm leading-relaxed relative ${
                      isDark
                        ? "bg-stone-900/20 border-stone-800 text-stone-300"
                        : "bg-stone-50/50 border-[#ebe1d5] text-stone-750 font-medium"
                    }`}
                  >
                    {/* Quote mark backgrounds */}
                    <div className="absolute top-1 left-2 font-serif text-5xl opacity-10 select-none text-stone-400">
                      “
                    </div>
                ...
                {/* <div className="space-y-3">
                  <h4 className="text-[11px] font-black tracking-widest text-stone-500 dark:text-stone-400 uppercase flex items-center space-x-2 border-b border-stone-800/10 dark:border-stone-500/10 pb-2">
                    ...
                    <span>核心天赋 / CORE STRENGTHS</span>
                  </h4>
                  <div
                    className={`p-4 rounded-2xl border text-xs leading-relaxed transition-colors ${
                      isDark
                        ? "bg-cyan-950/10 border-cyan-500/15"
                        : "bg-[#fffdf7] border-[#ebe1d5]"
                    }`}
                  >
                    <p
                      className={`font-black text-[14px] mb-1.5 text-cyan-400 flex items-center space-x-1.5`}
                    >
                ...
                <div className="space-y-3">
                  <h4 className="text-[11px] font-black tracking-widest text-rose-500 uppercase flex items-center space-x-2 border-b border-stone-800/10 dark:border-stone-500/10 pb-2">
                    ...
                    <span>人格阴影 / SHADOW TRAITS</span>
                  </h4>
                  <div
                    className={`p-4 rounded-2xl border text-xs leading-relaxed ${
                      isDark
                        ? "bg-[#ff0055]/5 border-[#ff0055]/10 text-rose-300"
                ...
                <div className="space-y-3.5">
                  <h4 className="text-[11px] font-black tracking-widest text-stone-500 dark:text-stone-400 uppercase flex items-center space-x-2 border-b border-stone-800/10 dark:border-stone-500/10 pb-2">
                    ...
                    <span>理想共鸣 / IDEAL MATCHES</span>
                  </h4>
                  <div
                    className={`p-4 rounded-2xl border ${isDark ? "bg-stone-950/10 border-[#1c1d3a]" : "bg-[#fffdf7] border-[#ebe1d5]"}`}
                  >
                ...
                <div className="space-y-4 pt-2">
                  <h4 className="text-[11px] font-black tracking-widest text-stone-500 dark:text-stone-400 uppercase flex items-center space-x-2 border-b border-stone-800/10 dark:border-stone-500/10 pb-2">
                    ...
                    <span>发展里程碑 / DEVELOPMENTAL MILESTONES</span>
                  </h4>
                  <div className="flex flex-col space-y-3.5 font-sans mt-2 pl-2">
                    {matchedChar.milestones?.map(
                      (milestone: string, mIdx: number) => (
                        <div
                          key={mIdx}
                        ...
                        >
                          ...
                          <div className="space-y-0.5 pt-0.5">
                            <span
                              className={
                                isDark
                                  ? "text-stone-200 font-bold leading-relaxed"
                                  : "text-stone-750 font-semibold"
                              }
                            >
                              {milestone}
                            </span>
            ...
            {shadowChar && (
              <div
                className={`mt-10 pt-8 border-t font-sans ${
                  isDark ? "border-stone-800/65" : "border-stone-200/50"
                }`}
              >
                <div
                  className={`p-5 rounded-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 text-xs transition-colors ${
                    isDark
                      ? "bg-black/25 border border-stone-800 text-stone-300"
                      : "bg-stone-50 border border-stone-250 text-stone-600"
                  }`}
                >
                  <div className="space-y-1.5 max-w-xl">
                    <div className="flex items-center space-x-1.5 text-purple-400 font-black uppercase text-[10px] tracking-widest">
                      ...
                      <span>影子人格 / SHADOW PERSONALITY</span>
                    </div>
                  ...
                  <div
                    className={`flex items-center space-x-3.5 shrink-0 self-start sm:self-center p-3.5 rounded-xl border ${
                      isDark
                        ? "bg-stone-900/10 border-stone-800/10 dark:border-stone-500/5"
                        : "bg-[#fffdf7] border-[#ebe1d5]"
                    }`}
                  >
                    ...
                    <div>
                      <p
                        className={`font-black tracking-wide text-sm ${isDark ? "text-white" : "text-stone-800"}`}
                      >
                        {shadowChar.name}
                      </p>
      ...
      <section id="result-analytics" className="max-w-4xl mx-auto px-4">
        ...
        >
          <h3
            className={`text-md font-mono tracking-wider font-extrabold mb-6 text-stone-400 uppercase`}
          >
            维度偏好分布
          </h3>
            ...
            {mbtiDetails.map((dim, i) => (
              <div key={i} className="space-y-2">
                ...
                <div className="flex items-center justify-between font-bold text-xs sm:text-sm">
                  {/* Left Label */}
                  <span
                    className={`${dim.leftPct >= 50 ? (isDark ? "text-cyan-400" : "text-stone-955") : "text-stone-400"}`}
                  >
                  ...
                  {/* Meter Track */}
                  <div
                    className={`h-3 flex-1 mx-4 rounded-full overflow-hidden ${
                  ...
                  {/* Right Label */}
                  <span
                    className={`${dim.rightPct > 51 ? (isDark ? "text-cyan-400" : "text-stone-955") : "text-stone-400"}`}
                  >
                    <span className="font-mono">{dim.rightPct}%</span>{" "}
                    {dim.right}
                  </span>
                </div>
              </div>
      ...
      <section id="result-cta" className="max-w-4xl mx-auto px-4 text-center">
        ...
        >
          <h2
            className={`text-xl font-extrabold mb-3 ${isDark ? "text-white" : "text-stone-800"}`}
          >
            探索更多人格角色
          </h2>
          <p
            className={`text-sm max-w-lg mx-auto mb-6 ${isDark ? "text-stone-300" : "text-[#645c52]"}`}
          >
            你可以在“角色目录”中翻阅全部 MBTI
            人格类型的小马角色卡片，深入了解每个角色的性格画像。
          </p>
