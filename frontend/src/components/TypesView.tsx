          ...
          <div className="border-t border-stone-800/10 dark:border-stone-850/50 pt-4">
            ...
            <div className="flex flex-wrap gap-1.5">
              ...
              {allMbtis.map((mbti) => {
                ...
                const fitsGroup =
                  activeGroup === "All" ||
                  (archetype && archetype.group === activeGroup);
      ...
      <div id="types-grid" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {filteredCharacters.length > 0 || filteredPersonalities.length > 0 ? (
          <div className="space-y-16">
            ...
            {filteredPersonalities.length > 0 && (
              <div className="space-y-6">
                <div className="flex items-center space-x-3 pb-3 border-b border-stone-850/10 dark:border-stone-800/40">
                  <div
                    className={`w-2.5 h-6 rounded-full bg-gradient-to-b from-cyan-400 to-indigo-500`}
                  />
                  <h2
                  ...
                  {filteredPersonalities.map((p, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`absolute top-0 left-0 right-0 h-1.5 rounded-t-3xl opacity-75 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-r ${
                            p.group === "Analysts"
                        ...
                        <div className="flex justify-between items-start mb-5 pt-2">
                          <div
                            className={`w-12 h-12 rounded-2xl flex items-center justify-center text-3xl bg-gradient-to-br shadow-inner transition-transform group-hover:scale-110 duration-300 ${getAvatarBg(p.id)} overflow-hidden`}
                          >
                            <span className="select-none">{p.avatar}</span>
                          </div>
                          <span
                            className={`text-[10px] font-mono tracking-widest font-black px-2.5 py-1 rounded-md border ${getGroupBadgeStyles(p.group)}`}
                          >
                            {p.id}
                          </span>
                        </div>
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center space-x-2">
                            <h3
                              className={`text-lg font-black tracking-wide ${isDark ? "text-white" : "text-stone-850"}`}
                            >
                              {p.name}
                            </h3>
                            <span
                          ...
                          <p
                            className={`text-xs font-semibold tracking-wider ${isDark ? "text-cyan-400" : "text-[#b3a076]"}`}
                          >
                            {p.title}
                          </p>
                        </div>
                        ...
                        <p
                          className={`text-xs mt-3.5 mb-5 leading-relaxed line-clamp-3 h-[54px] ${
                        ...
                        <div
                          className={`p-2.5 rounded-xl border text-[11px] leading-relaxed mb-4 flex flex-col space-y-1 ${
                            isDark
                              ? "bg-stone-950/50 border-stone-850/50 text-stone-400"
                              : "bg-stone-50 border-stone-100 text-stone-550"
                          }`}
                        >
                        ...
                        {/* Footer action */}
                        <div
                          className={`pt-3 border-t flex items-center justify-between text-[11px] font-black transition-all duration-300 ${
                            isDark
                              ? "border-stone-850 text-cyan-400/85 group-hover:text-cyan-300"
                              : "border-stone-100 text-[#a39474] group-hover:text-stone-905"
                          }`}
                        >
                          <span className="tracking-wide text-neutral-500 dark:text-neutral-400 font-medium">
                            16型原生人格
                          </span>
            ...
            {filteredCharacters.length > 0 && (
              <div className="space-y-6 pt-6">
                <div className="flex items-center space-x-3 pb-3 border-b border-stone-850/10 dark:border-stone-800/40">
                  <div
                    className={`w-2.5 h-6 rounded-full bg-gradient-to-b from-cyan-400 to-rose-450`}
                  />
                  <h2
                    className={`text-2xl font-black ${isDark ? "text-white" : "text-stone-900"}`}
                  >
                  ...
                  {filteredCharacters
                    ...
                    .map((char, index) => (
                      ...
                      >
                        ...
                        <div
                          className={`absolute top-0 left-0 right-0 h-1.5 rounded-t-3xl opacity-75 group-hover:opacity-100 transition-opacity duration-300 ${getProbabilityColorClass(
                            getCharProb(char.id, char.mbti),
                          )}`}
                        />

                        {/* Top large image/avatar wrapper occupying exactly 90% space */}
                        <div
                          className={`w-[90%] mx-auto aspect-square rounded-2xl flex items-center justify-center bg-gradient-to-br ${isDark ? "shadow-inner" : ""} transition-transform group-hover:scale-[1.03] duration-300 ${getAvatarBg(char.mbti)} overflow-hidden mb-4 mt-2`}
                        >
                          {isImageUrl(char.avatar) && !imgErrors[char.id] ? (
                            ...
                            <span className="referrer-policy select-none text-5xl sm:text-6xl">
                        ...
                        <div className="space-y-1 px-1">
                          <div className="flex items-center justify-between">
                            ...
                            <span
                              className={`text-[10px] font-mono tracking-widest font-black px-2 py-0.5 rounded-md border ${getGroupBadgeStyles(getMbtiGroup(char.mbti))}`}
                            >
                              {char.mbti}
                            </span>
                          </div>
                        ...
                        <p
                          className={`text-xs mt-3 mb-3 leading-relaxed line-clamp-3 h-[54px] px-1 ${
                            isDark ? "text-stone-400" : "text-stone-600"
                          }`}
                        >
                          {char.description}
                          ...
                          {char.traits.map((trait, tIdx) => (
                            <span
                              ...
                              className={`text-[9px] font-extrabold px-1.5 py-0.5 rounded border ${
                                isDark
                                  ? "bg-stone-900/60 border-stone-800 text-stone-300"
                                  : "bg-stone-50 border-stone-200 text-stone-606 animate-fade"
                              }`}
                            >
                              #{trait}
                            </span>
                        ...
                        >
                          <span className="tracking-wide flex items-center space-x-1">
                            <span>
                              测评概率 {getCharProb(char.id, char.mbti)}%
                            </span>
                          </span>
                          <div className="flex items-center space-x-1">
                            <span>核对智识细节</span>
          ...
          <div className="text-center py-20 rounded-3xl border border-dashed border-[#ebdcc9] dark:border-stone-800 max-w-md mx-auto space-y-4">
            <span className="text-4xl text-stone-500 block animate-bounce">
              🛸
            </span>
            <h3
            ...
            >
              ...
              <div
                className={`h-2.5 w-full bg-gradient-to-r ${
                  getMbtiGroup(activeDetailChar.mbti) === "Analysts"
                    ? "from-purple-500 to-indigo-500"
                    : getMbtiGroup(activeDetailChar.mbti) === "Diplomats"
                      ? "from-pink-500 to-rose-400"
                      : getMbtiGroup(activeDetailChar.mbti) === "Sentinels"
                        ? "from-blue-500 to-cyan-500"
                        : "from-amber-400 to-yellow-500"
                }`}
              />
              ...
              <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-10 gap-8 items-center pb-8 border-b border-stone-800/10 dark:border-stone-800/30">
                  ...
                  <div className="md:col-span-3 flex justify-center">
                    <div
                      className={`w-28 h-28 md:w-44 md:h-44 lg:w-52 lg:h-52 rounded-3xl flex items-center justify-center text-7xl bg-gradient-to-br ${isDark ? "shadow-inner" : ""} ${getAvatarBg(activeDetailChar.mbti)} overflow-hidden`}
                    >
                      {isImageUrl(activeDetailChar.avatar) &&
                      !imgErrors[activeDetailChar.id] ? (
                        <img
                          ...
                          onError={() =>
                            setImgErrors((prev) => ({
                              ...prev,
                              [activeDetailChar.id]: true,
                            }))
                          }
                        />
                      ) : (
                        <span className="select-none">
                          {activeDetailChar.avatar || activeDetailChar.name[0]}
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-7 space-y-4 text-left">
                    <div className="space-y-1.5">
                      <div className="flex flex-wrap items-center gap-3">
                        <h2
                          className={`text-2xl md:text-3xl font-extrabold tracking-tight ${isDark ? "text-white" : "text-stone-900"}`}
                        >
                          {activeDetailChar.name}
                        </h2>
                        <span
                          className={`text-xs font-mono font-black border px-3 py-1 rounded-full ${getGroupBadgeStyles(getMbtiGroup(activeDetailChar.mbti))}`}
                        >
                    ...
                    <p
                      className={`text-sm leading-relaxed ${isDark ? "text-stone-300" : "text-stone-600"}`}
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
                  ...
                  <div className="lg:col-span-7 space-y-6">
                    ...
                    <div className="space-y-4">
                      <h4
                        className={`text-[11px] font-bold tracking-wider uppercase flex items-center space-x-1.5 ${
                      ...
                      <div
                        className={`space-y-3 p-5 rounded-3xl border ${
                          isDark
                      ...
                      >
                        ...
                        <div className="space-y-1.5 text-xs">
                          <div className="flex justify-between font-mono">
                            <span
                              className={
                                activeDetailChar.stats.E >=
                                activeDetailChar.stats.I
                                  ? isDark
                                    ? "font-bold text-cyan-400"
                                    : "font-bold text-[#b4995e]"
                                  : isDark
                                    ? "text-stone-550"
                                    : "text-[#a59984]"
                              }
                            >
                              E 外倾 ({activeDetailChar.stats.E}%)
                            </span>
                            <span
                              className={
                                activeDetailChar.stats.I >=
                                activeDetailChar.stats.E
                                  ? isDark
                                    ...
                                    : "font-bold text-[#83709b]"
                                  : isDark
                                    ? "text-stone-550"
                                    : "text-[#a59984]"
                              }
                            >
                              内倾 I ({activeDetailChar.stats.I}%)
                            </span>
                          </div>
                          <div
                            className={`h-2 w-full rounded-full overflow-hidden flex ${isDark ? "bg-stone-900" : "bg-stone-200/60"}`}
                          >
                            <div
                              style={{ width: `${activeDetailChar.stats.E}%` }}
                              className={`h-full ${isDark ? "bg-cyan-400" : "bg-[#bda574]"}`}
                            />
                            <div
                              style={{ width: `${activeDetailChar.stats.I}%` }}
                              className={`h-full ${isDark ? "bg-indigo-500" : "bg-[#988aa8]"}`}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-1.5 text-xs">
                          <div className="flex justify-between font-mono">
                            <span
                              className={
                                activeDetailChar.stats.S >=
                                activeDetailChar.stats.N
                                  ? isDark
                                    ? "font-bold text-cyan-400"
                                    : "font-bold text-[#b4995e]"
                                  : isDark
                          ...
                          >
                            <div
                              style={{ width: `${activeDetailChar.stats.S}%` }}
                              className={`h-full ${isDark ? "bg-cyan-400" : "bg-[#bda574]"}`}
                            />
                            <div
                              style={{ width: `${activeDetailChar.stats.N}%` }}
                              className={`h-full ${isDark ? "bg-indigo-500" : "bg-[#988aa8]"}`}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-1.5 text-xs">
                          <div className="flex justify-between font-mono">
                            <span
                              className={
                                activeDetailChar.stats.T >=
                                activeDetailChar.stats.F
                                  ? isDark
                                    ? "font-bold text-cyan-400"
                                    : "font-bold text-[#b4995e]"
                                  : isDark
                          ...
                          >
                            <div
                              style={{ width: `${activeDetailChar.stats.T}%` }}
                              className={`h-full ${isDark ? "bg-cyan-400" : "bg-[#bda574]"}`}
                            />
                            <div
                              style={{ width: `${activeDetailChar.stats.F}%` }}
                              className={`h-full ${isDark ? "bg-indigo-500" : "bg-[#988aa8]"}`}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-1.5 text-xs">
                          <div className="flex justify-between font-mono">
                            <span
                              className={
                                activeDetailChar.stats.J >=
                                activeDetailChar.stats.P
                                  ? isDark
                                    ? "font-bold text-cyan-400"
                                    : "font-bold text-[#b4995e]"
                                  : isDark
                            ...
                            >
                              J 独立/判断 ({activeDetailChar.stats.J}%)
                            </span>
                            <span
                              className={
                                activeDetailChar.stats.P >=
                            ...
                            >
                              知觉/弹性 P ({activeDetailChar.stats.P}%)
                            </span>
                          </div>
                          <div
                            className={`h-2 w-full rounded-full overflow-hidden flex ${isDark ? "bg-stone-900" : "bg-stone-200/60"}`}
                          >
                            <div
                              style={{ width: `${activeDetailChar.stats.J}%` }}
                              className={`h-full ${isDark ? "bg-cyan-400" : "bg-[#bda574]"}`}
                            />
                            <div
                              style={{ width: `${activeDetailChar.stats.P}%` }}
                              className={`h-full ${isDark ? "bg-indigo-500" : "bg-[#988aa8]"}`}
                            />
                          </div>
                        </div>
                    ...
                    {activeDetailChar.bestPartners &&
                      activeDetailChar.bestPartners.length > 0 && (
                  ...
                  <div className="lg:col-span-5 space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <h5
                          className={`text-[10px] font-black tracking-wider uppercase flex items-center space-x-1.5 ${
                      ...
                      >
                        ...
                        >
                          <Info
                            className={`w-3.5 h-3.5 ${isDark ? "text-rose-400" : "text-[#c66868]"}`}
                          />
                          <span
                        ...
                        <p
                          className={`text-xs font-semibold leading-relaxed ${isDark ? "text-white" : "text-stone-700"}`}
                        >
                    ...
                    {/* Milestones timeline */}
                    {activeDetailChar.milestones &&
                      activeDetailChar.milestones.length > 0 && (
                        <div className="space-y-3">
                          <h4 className="text-[11px] font-bold tracking-wider text-stone-500 dark:text-stone-400 uppercase flex items-center space-x-1.5">
